            ...
            {activeCodeTab === 'settings' && (
              <div className="flex-1 p-6 space-y-4 overflow-y-auto">
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-stone-300 mb-1.5">Köhnə Qiymət</label>
                    <input
                      type="number"
                      min="0"
                      step="0.01"
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-stone-300 mb-1.5">Valyuta</label>
                    <select
                      value={currency}
